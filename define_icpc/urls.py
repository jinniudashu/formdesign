...
from .views import get_icpc1_register_logins, get_icpc2_reservation_investigations, get_icpc3_symptoms_and_problems, get_icpc4_physical_examination_and_tests, get_icpc5_evaluation_and_diagnoses, get_icpc6_prescribe_medicines, get_icpc7_treatments, get_icpc8_other_health_interventions, get_icpc9_referral_consultations, get_icpc10_test_results_and_statistics
