# Generated by Django 4.0 on 2022-03-26 12:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_from', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='define_operand.buessinessform', verbose_name='基础表单')),
            ],
            options={
                'verbose_name': '业务管理实体',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='define_operand.ManagedEntity', verbose_name='关联实体'),
        ),
        migrations.AddField(
            model_name='buessinessform',
            name='name_icpc',
