# Generated by Django 4.0 on 2022-10-29 08:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_packages', models.ManyToManyField(blank=True, to='define_operand.ServicePackage', verbose_name='项目服务包')),
                ('service_rules', models.ManyToManyField(blank=True, to='define_operand.ServiceRule', verbose_name='项目服务规则')),
                ('services', models.ManyToManyField(to='define_operand.Service', verbose_name='项目')),
            ],
            options={
                'verbose_name': '项目列表',
