    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.DurationField(blank=True, null=True, verbose_name='间隔时间')),
                ('description', models.CharField(blank=True, max_length=255, null=True, verbose_name='说明')),
                ('operand_interval_rule_id', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='规则ID')),
            ],
            options={
                'verbose_name': '间隔规则',
