# Generated by Django 4.0 on 2022-03-22 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buessiness_form', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='define_operand.buessinessform', verbose_name='作业表单')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('begin_time_setting', models.PositiveSmallIntegerField(choices=[(0, '默认当前时间'), (1, '人工指定时间'), (2, '引用出生日期')], default=0, verbose_name='开始时间设置')),
                ('execution_time_frame', models.DurationField(blank=True, null=True, verbose_name='执行时限')),
                ('awaiting_time_frame', models.DurationField(blank=True, null=True, verbose_name='等待执行时限')),
                ('priority', models.PositiveSmallIntegerField(choices=[(0, '0级'), (1, '紧急'), (2, '优先'), (3, '一般')], default=3, verbose_name='优先级')),
                ...
                ('first_operation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first_operation', to='define_operand.operation', verbose_name='起始作业')),
                ...
                ('managed_entity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='define.managedentity', verbose_name='管理实体')),
                ('name_icpc', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='define_icpc.icpc', verbose_name='ICPC编码')),
            ],
            options={
                'verbose_name': '服务',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='define_rule_dict.eventrule', verbose_name='条件事件')),
                ...
                ('interval_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='define_rule_dict.intervalrule', verbose_name='服务时间间隔')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_rule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='define_rule_dict.eventrule', verbose_name='条件事件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='define.managedentity', verbose_name='关联实体')),
