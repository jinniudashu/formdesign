# Generated by Django 4.0 on 2021-12-30 13:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baseforms', models.ManyToManyField(blank=True, limit_choices_to={'is_inquiry': True}, related_name='inquire_forms', to='define.BaseForm', verbose_name='查询视图')),
            ],
            options={
                'verbose_name': '查询视图',
                'verbose_name_plural': '查询视图',
                'ordering': ['id'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True, verbose_name='name')),
                ('label', models.CharField(blank=True, max_length=100, null=True, verbose_name='表单名称')),
                ('baseforms', models.ManyToManyField(blank=True, limit_choices_to={'is_inquiry': False}, related_name='mutate_forms', to='define.BaseForm', verbose_name='变更视图')),
            ],
            options={
                'verbose_name': '变更视图',
                'verbose_name_plural': '变更视图',
                'ordering': ['id'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True, verbose_name='name')),
                ('label', models.CharField(blank=True, max_length=100, null=True, verbose_name='表单名称')),
                ('inquire_forms', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='define.inquireform', verbose_name='查询视图')),
                ...
                ('mutate_forms', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='define.mutateform', verbose_name='变更视图')),
            ],
            options={
                'verbose_name': '作业界面',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(blank=True, max_length=100, null=True, verbose_name='表单名称')),
                ('description', models.TextField(blank=True, max_length=255, null=True, verbose_name='描述')),
                ('base_infomation', models.BooleanField(default=False, verbose_name='基础信息表')),
                ('components', models.ManyToManyField(to='define.Component', verbose_name='组件清单')),
                ('managed_entity', models.ManyToManyField(blank=True, null=True, to='define.ManagedEntity', verbose_name='实体类型')),
            ],
            options={
                'verbose_name': '基础表单',
